...
int main() {
	...
	std::ifstream inp1File{ "C:/Users/Alex/source/repos/Basics_of_C_Plus_Plus_programming/Basic of programming on CPlusPlus/Task_3/task_3.1/in.txt" };
	inp1File >> f;
	std::cout << f << std::endl;
	...
	//Запись в файл
	std::cout << std::endl;
	std::ofstream outFile{ "C:/Users/Alex/source/repos/Basics_of_C_Plus_Plus_programming/Basic of programming on CPlusPlus/Task_3/task_3.1/out.txt" };
	outFile << f << "\n";
	for (int k = f-1; k >= 0; k--) {
